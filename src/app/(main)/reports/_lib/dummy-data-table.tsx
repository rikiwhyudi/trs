...
export type DataTicket = {
  id: string;
  title?: string; // Jadikan opsional jika bisa null
  description?: string; // Jadikan opsional jika bisa null
  location?: string;
  ...
  rootcause_solution?: string | null;
  created_at?: string;
};
...
export const dataTicket: DataTicket[] = [
  {
      ...
      resolved_notes: "PHNS-M000 PHNS-I000 / Tiket diselesaikan karena teratasi sebelum penanganan ~ MYDR",
      status: "active",
