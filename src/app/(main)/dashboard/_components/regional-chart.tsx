...
const labels = ["Regional 1", "Regional 2", "Regional 3", "Regional 4"];
const dataValues = [17, 13, 11, 14]; // Memperbaiki jumlah elemen agar sesuai dengan labels
  ...
  datasets: [
    {
      ...
      backgroundColor: ["#003f5c", "#bc5090", "#ff6361", "#ffa600"], // Warna dari kodemu
...
export default function VerticalBarChartRegional() {
  return (
    <Card className="flex flex-col bg-card text-card-foreground rounded-xl p-6 shadow-sm" style={{ height: `300px` }}>
      ...
      <div style={{ position: "relative", flexGrow: 1, minHeight: "0px" }}>
        <Bar
          ...
          options={createVerticalBarChartOptions("Distribusi Regional Tiket (Aktif/Pending)")}
        />
      </div>
